...
export default function BarDetail() {
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-8 animate-reveal-up space-y-10">
            <Link 
                to="/mapa" 
            ...
            {/* Header Card */}
            <div className="glass-panel-premium rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-3xl">
                <div className="relative h-[300px] md:h-[400px] w-full group">
                    ...
                    <div className="absolute bottom-6 md:bottom-8 left-6 md:left-10 right-6 md:right-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                        ...
                        <div className="flex flex-row md:flex-col items-center gap-2 p-4 md:p-6 bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-[2.5rem] shadow-2xl">
                ...
                <div className="p-8 md:p-14 space-y-6 md:space-y-8">
                ...
                <div className="grid grid-cols-1 gap-6">
                    {bar.reviews && bar.reviews.length > 0 ? (
                        bar.reviews.map((rev: any) => (
                            <div key={rev.id} className="glass-panel p-8 rounded-[2rem] border-white/5 hover:border-white/10 transition-all shadow-xl group">
                                <div className="flex gap-6">
                                    <img 
                                        src={imageUrl(rev.user?.avatarUrl) || 'https://cdn-icons-png.flaticon.com/512/3135/3135715.png'} 
                                        alt="user" 
                                        className="w-14 h-14 rounded-2xl object-cover border-2 border-shisha-ember shadow-lg" 
                                    />
            ...
            {/* Add Review Section */}
            {user ? (
                <div className="glass-panel-premium p-8 md:p-14 rounded-[2.5rem] md:rounded-[3rem] border-white/10 shadow-3xl space-y-8 md:space-y-10">
                    ...
                    <form onSubmit={handleSubmitReview} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <textarea 
                                ...
                                required 
                                rows={4} 
                                className="w-full px-8 py-6 rounded-[2rem] bg-white/5 border border-white/5 text-white placeholder:text-shisha-text-dim focus:bg-white/10 focus:border-shisha-ember/40 outline-none transition-all font-medium resize-none shadow-inner" 
                ...
                <div className="glass-panel p-16 rounded-[3rem] text-center space-y-8">
